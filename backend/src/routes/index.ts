...
export default async function createRoutes(fastify: FastifyInstance) {
  ...
  // --- Publications publiques (Lecture seule) - Filtrage public/published auto dans controller.findAll
  registry.registerCrud(publicationController, {
    path: "/api/public/publications",
    methods: ["findAll", "findById"], // Seules les lectures sont permises
    protected: false, // Accès non-authentifié
  });
