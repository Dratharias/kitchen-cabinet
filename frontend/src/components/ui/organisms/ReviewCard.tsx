  ...
  return (
    <div class="border rounded p-4 mb-4 flex flex-col md:flex-row gap-4">
      <div class="flex-1 flex flex-col">
        <Span class="font-semibold text-lg text-prim-txt dark:text-prim-txt-d">
          {props.publicationTitle || "Publication inconnue"}
        </Span>
        ...
        <div class="mt-1 text-xs text-sec-txt dark:text-sec-txt-d">
          Date de la review :{" "}
          {new Date(props.dateReview).toLocaleDateString("fr-FR")}
        </div>
      </div>
    </div>
  );
